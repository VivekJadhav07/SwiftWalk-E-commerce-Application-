...
public class MyAccountFragment extends Fragment {
   private FloatingActionButton settingsBtn;
    ...
    private TextView ypurRecentOrdersTitle;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ypurRecentOrdersTitle=view.findViewById(R.id.your_recent_orders_title);
            ...
            public void onDismiss(DialogInterface dialogInterface) {
                for (MyOrderItemModel orderItemModel: DBqueries.myOrderItemModelList){
                    if (!orderItemModel.isCancellationRequested()){
                        if (!orderItemModel.getOrderStatus().equals("Delivered") && !orderItemModel.getOrderStatus().equals("Cancelled")){
                            ...
                            Glide.with(getContext()).load(orderItemModel.getProductImage()).apply(new RequestOptions().placeholder(R.drawable.img))
                ...
                for (MyOrderItemModel myOrderItemModel: DBqueries.myOrderItemModelList){
                    if (myOrderItemModel.getOrderStatus().equals("Delivered")){
                        if(i<4) {
                            Glide.with(getContext()).load(myOrderItemModel.getProductImage()).apply(new RequestOptions().placeholder(R.drawable.img))
                ...
                if (i==0){
                    ypurRecentOrdersTitle.setText("No recent orders.");
                }
                if (i<3){
                    for (int x=i;x<4;x++){
        ...
        viewAllAddressBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent myAddressesIntent=new Intent(getContext(),My_AddressesActivity.class);
    ...
    private void setAddress() {
        ...
        String alternateMobileNo = DBqueries.addressesModelList.get(DBqueries.selectedAddress).getAlternatemobileNo();
        if (alternateMobileNo != null && alternateMobileNo.equals("")) {
            addressName.setText(name + " - " + mobileNo);
        } else {
            addressName.setText(name + " - " + mobileNo + " or " + (alternateMobileNo != null ? alternateMobileNo : ""));
        }
